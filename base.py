...
class BaseImpact(Impact, base_path):
    ...
    def get_weather(self, weather, preds, metadata):
        ...
        for pred in preds:
            ...
            base_weather_pred.append(self._construct_baseline_weather(annual_weather_paths_tas, self.metadata, self.base_years))
    ...
    def compute(self, gammas, gdp_covars, clim_covars):
        ...
        if not self.weather_computed:
            self.weather_computed = self.get_weather(self.weather, self.preds, self.metadata)
    ...
    def impact_function(self, betas, weather):
        ...
        self._basline_to_netcdf(impact, self.metadata, self.write_path)
